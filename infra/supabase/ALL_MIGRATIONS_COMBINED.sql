...
-- Generated: 2026-09-01T08:50:33Z
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260809000001_booking_integrity.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260809000002_org_brand_establishment.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260809164025_harden_function_execution_and_search_path.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260809170901_business_categories_and_open_member_requests.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260810000001_account_deletion_task_cleanup.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260811000001_creator_profile_upsert_and_public_media.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260811140001_business_category_sort_hotel_first.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260811143001_marvi_db_integrity_check.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260811150001_lifecycle_emails_and_ops_monitoring.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260811160001_admin_user_media_and_directory.sql
-- ═══════════════════════════════════════════════════════════════════════════
-- Admin user directory: avatars/covers in list + admin photo set/clear + storage write for admins.
...
-- Empty/null p_url clears the photo. Non-empty sets it.
...
BEGIN
    ...
    -- Ensure a creator row exists so admin can manage media for any member.
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260812180001_admin_campaign_control.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813010001_inbox_role_polish.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813150001_fix_admin_tasks_resolved_at.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813190001_category_sort_hotel_restaurant_cafe.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813200001_venue_soft_delete_offer.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813210001_venue_role_locks_workspace.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813220001_venue_admin_review_notifications.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813230001_repair_venue_role_and_review_notifications.sql
-- ═══════════════════════════════════════════════════════════════════════════
-- Repair: previous venue role backfill could fail under privilege guards;
-- ensure review notifications + role lock are applied.
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813240001_backfill_venue_approved_notifications.sql
-- ═══════════════════════════════════════════════════════════════════════════
INSERT INTO public.notifications (user_id, title, body, type, icon, tint, payload)
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813250001_admin_list_venues_and_bookings.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260813260001_venue_resubmit_edit_flow.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260814010001_admin_venue_soft_delete.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260814020001_admin_queue_sync_and_membership_fix.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260814030001_campaign_auto_live_for_approved_venues.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260814040001_fix_pending_collab_and_approval_copy.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260814050001_harden_collab_accept_and_decline.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260814060001_venue_map_coords_sync_and_push_trigger.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260814070001_dedupe_venue_profiles_and_reuse.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260831000001_social_event_notifications.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 20260831020001_venue_billing_safety_and_trust.sql
-- ═══════════════════════════════════════════════════════════════════════════
