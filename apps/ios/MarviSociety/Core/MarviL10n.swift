...
enum MarviL10n {
    ...
    private static let english: [Key: String] = [
        ...
        .socialVerifyCopyCode: "Copy code",
        .socialVerifyOpenInstagram: "Open @marvisociety on Instagram",
        .socialVerifySentBtn: "I sent the code in DM",
        .socialVerifyPending: "Waiting for your DM",
        .socialVerifySubmitted: "Code sent — admin review pending",
    ...
    private static let turkish: [Key: String] = [
        ...
        .socialVerifyCopyCode: "Kodu kopyala",
        .socialVerifyOpenInstagram: "Instagram'da @marvisociety aç",
        .socialVerifySentBtn: "Kodu DM ile gönderdim",
        .socialVerifyPending: "DM'in bekleniyor",
        .socialVerifySubmitted: "Kod gönderildi — admin incelemesi bekleniyor",
