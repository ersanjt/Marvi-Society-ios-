...
enum MarviL10n {
    ...
    enum Key: String, CaseIterable {
        ...
        case adminInvitesSub, adminInvitesEmpty, adminInvitesEmptySub
        ...
        case estWizardEstablishmentNamePh, estWizardCreateDraft, estWizardSubmitReview
        case estWizardInstagramPh, estWizardDescriptionCount, estWizardCategoriesLabel
        case estWizardContactNamePh, estWizardContactPhonePh, estWizardContactIsSelf
    ...
    private static let english: [Key: String] = [
        ...
        .introSlideAffiliateTitle: "Private Collaborations",
        .introSlideAffiliateSub: "Join invite-only campaigns with premium brands and venues",
        ...
        .inviteSubtitle: "Your code is sent by email only. Enter the invite you received from Marvi Society.",
        .invitePlaceholder: "Invite code from your email",
        ...
        .acceptInvitation: "Send request", .rsvpEvent: "Send RSVP request",
        ...
        .acceptNeedsSocialVerify: "Recommended: verify Instagram via DM in Profile (not required to accept).",
        .signInToAccept: "Sign in to accept invitations.",
        .socialVerifyTitle: "Verify your social accounts",
        .socialVerifySub: "Optional but recommended: copy your code, DM it to @marvisociety from Instagram, then tap “I sent the code”. Admin confirms — you can keep exploring meanwhile.",
        .socialVerifyCodeLabel: "Your verification code",
        .socialVerifyCopyCode: "Copy DM text",
        .socialVerifyOpenInstagram: "Open Instagram DM",
        .socialVerifySentBtn: "I sent the code in DM",
        .socialVerifyPending: "Step 1 — send the DM",
        .socialVerifySubmitted: "Step 2 — waiting for admin confirm",
        .socialVerifyVerified: "Social accounts verified",
        .socialVerifyConfirmAdmin: "Confirm Instagram DM",
        ...
        .underReviewBannerSub: "Your account is waiting for admin approval. You can use Marvi Society services after an operator approves your membership.",
        ...
        .checklistProgress: "of 8 steps complete",
        ...
        .adminVenueNoLiveHint: "Approved venue with no live campaign yet — partner should create one (it goes live on Explore automatically).",
        ...
        .adminInvitesEmptySub: "Create a code to invite creators or venues. Codes are never shown inside the member app.",
        .adminInviteCodeLabel: "Code",
        .adminInviteUsesLabel: "Joined",
        .adminInviteMaxUsesLabel: "Max uses",
        .adminCreateInviteCode: "Create invite code",
        .adminUpdateInviteQuota: "Update quota",
        ...
        .communitySearchPrompt: "Name, @handle, city, niche",
        .communityFeedTitle: "Following",
        .communityFeedSub: "Recent check-ins and showcase posts from people you follow.",
        .communityFeedEmpty: "Follow creators to see their visits and content here.",
        .communityMembersTitle: "Members",
        .communityMembersSub: "Approved creators in Marvi Society.",
        .communityMembersEmpty: "No members found",
        .communityMembersEmptySub: "Try another search or pull to refresh.",
        .memberCheckedInActivity: "Visited %@ · %@",
        .memberShowcaseActivity: "New showcase: %@",
        .messageAfterCollab: "In-app chat opens after you collaborate together.",
        ...
        .memberVenueOfferActivity: "New offer: %@ · %@",
        .venuePublicProfile: "Venue profile",
        .venueLiveOffers: "Live offers",
        ...
        .noBrandCampaignsSub: "Create a campaign — it goes live on Explore so creators can apply.",
        ...
        .swipeNeedsLiveTitle: "Invite creators",
        .swipeNeedsLiveSub: "Create a live campaign first, then shortlist creators. If they accept, the collaboration continues.",
        ...
        .newCampaign: "New campaign", .newCampaignSub: "Goes live on Explore so creators can apply right away.",
        ...
        .sendToAdminReview: "Publish on Explore", .createNav: "Create",
        ...
        .venueApprovedNeedsLiveCampaignSub: "Your venue is approved. Create a campaign and creators will see it on Explore — they can apply, or you can invite them.",
        ...
        .noActiveCampaignsApprovedSub: "Create a campaign to appear on Explore. Creators apply, or invite them from Community / Swipe.",
        ...
        .estWizardAddressSub: "Physical or online — add country, city, and map coordinates.",
        .estWizardPhotosTitle: "Photos",
        .estWizardPhotosSub: "Logo plus at least three gallery photos.",
        .estWizardExistingBrands: "Your brands",
        .estWizardCreateBrand: "Create organization & brand",
        .estWizardOrgNamePh: "Organization name",
        .estWizardBrandNamePh: "Brand name",
        .estWizardEstablishmentNamePh: "Establishment name",
        .estWizardCreateDraft: "Create draft",
        .estWizardSubmitReview: "Submit for review",
        .estWizardInstagramPh: "Instagram handle",
        .estWizardDescriptionCount: "%d / 200",
        .estWizardCategoriesLabel: "Categories",
        .estWizardContactNamePh: "Contact name",
        .estWizardContactPhonePh: "Contact phone",
        .estWizardContactIsSelf: "I am the contact",
        .estWizardLocationType: "Location type",
        .estWizardPhysical: "Physical",
        .estWizardOnline: "Online",
        .estWizardCountryPh: "Country",
        .estWizardCityPh: "City",
        .estWizardAreaPh: "Area / neighborhood",
        .estWizardAddress1Ph: "Address line 1",
        .estWizardAddress2Ph: "Address line 2 (optional)",
        ...
        .estWizardGalleryLabel: "Gallery",
        .estWizardAddGallery: "Add gallery photos",
        .estWizardGalleryCount: "%d photos selected",
        .estWizardPhotosHint: "Upload a logo and at least 3 gallery photos.",
        .errServerSetupReferral: "Server setup incomplete. Run apply-referral-form.sql in Supabase.",
    ...
    private static let turkish: [Key: String] = [
        ...
        .introSlideAffiliateTitle: "Özel İş Birlikleri",
        .introSlideAffiliateSub: "Seçkin markalar ve mekânlarla davetliye özel kampanyalara katıl",
        ...
        .inviteSubtitle: "Davet kodunuz yalnızca e-posta ile gönderilir. Aldığınız kodu buraya girin.",
        .invitePlaceholder: "E-postanızdaki davet kodu",
        ...
        .acceptInvitation: "Talep gönder", .rsvpEvent: "RSVP talebi gönder",
        ...
        .acceptNeedsSocialVerify: "Önerilir: Profilde Instagram DM doğrulaması (kabul için zorunlu değil).",
        .signInToAccept: "Davet kabul etmek için giriş yap.",
        .socialVerifyTitle: "Sosyal hesaplarını doğrula",
        .socialVerifySub: "İsteğe bağlı ama önerilir: kodunu kopyala, Instagram'dan @marvisociety'e DM at, sonra “Kodu DM ile gönderdim”e bas. Admin onaylar — bu sırada uygulamayı kullanmaya devam edebilirsin.",
        .socialVerifyCodeLabel: "Doğrulama kodun",
        .socialVerifyCopyCode: "DM metnini kopyala",
        .socialVerifyOpenInstagram: "Instagram DM aç",
        .socialVerifySentBtn: "Kodu DM ile gönderdim",
        .socialVerifyPending: "Adım 1 — DM gönder",
        .socialVerifySubmitted: "Adım 2 — admin onayı bekleniyor",
        .socialVerifyVerified: "Sosyal hesaplar doğrulandı",
        .socialVerifyConfirmAdmin: "Instagram DM doğrula",
        ...
        .underReviewBannerSub: "Hesabın admin onayını bekliyor. Operatör üyeliğini onayladıktan sonra Marvi Society hizmetlerini kullanabilirsin.",
        ...
        .checklistProgress: "/ 8 adım tamamlandı",
        ...
        .adminVenueNoLiveHint: "Onaylı mekân, henüz canlı kampanya yok — partner kampanya oluştursun (Keşfet’te otomatik canlı olur).",
        ...
        .adminInvitesEmptySub: "Creator veya mekân davet etmek için kod oluşturun. Kodlar üye uygulamasında gösterilmez.",
        .adminInviteCodeLabel: "Kod",
        .adminInviteUsesLabel: "Katılan",
        .adminInviteMaxUsesLabel: "Maks kullanım",
        .adminCreateInviteCode: "Davet kodu oluştur",
        .adminUpdateInviteQuota: "Kotayı güncelle",
        ...
        .communitySearchPrompt: "İsim, @handle, şehir, niş",
        .communityFeedTitle: "Takip ettiklerin",
        .communityFeedSub: "Takip ettiklerinin check-in ve vitrin paylaşımları.",
        .communityFeedEmpty: "Creator takip edince ziyaret ve içerikleri burada görünür.",
        .communityMembersTitle: "Üyeler",
        .communityMembersSub: "Marvi Society onaylı creator'lar.",
        .communityMembersEmpty: "Üye bulunamadı",
        .communityMembersEmptySub: "Başka bir arama dene veya yenile.",
        .memberCheckedInActivity: "%@ ziyaret etti · %@",
        .memberShowcaseActivity: "Yeni vitrin: %@",
        .messageAfterCollab: "Uygulama içi sohbet, iş birliği başladıktan sonra açılır.",
        ...
        .commentRequired: "Önce bir yorum yaz.",
        .memberVenueOfferActivity: "Yeni teklif: %@ · %@",
        .venuePublicProfile: "Mekân profili",
        .venueLiveOffers: "Aktif teklifler",
        .venueKindLabel: "Mekân",
        ...
        .noBrandCampaignsSub: "Kampanya oluştur — Keşfet’te canlı olur; creator’lar başvurabilir.",
        ...
        .swipeNeedsLiveTitle: "Creator davet et",
        .swipeNeedsLiveSub: "Önce canlı kampanya oluştur, sonra shortlist yap. Kabul ederlerse işbirliği devam eder.",
        ...
        .newCampaign: "Yeni kampanya", .newCampaignSub: "Keşfet’te hemen canlı olur; creator’lar başvurabilir.",
        ...
        .sendToAdminReview: "Keşfet’te yayınla", .createNav: "Oluştur",
        ...
        .venueApprovedNeedsLiveCampaignSub: "Mekânın onaylandı. Kampanya oluştur; creator’lar Keşfet’te görür ve başvurur — sen de doğrudan davet edebilirsin.",
        ...
        .noActiveCampaignsApprovedSub: "Keşfet’te görünmek için kampanya oluştur. Creator başvurur veya Community / Swipe’dan davet edersin.",
        ...
        .estWizardAddressSub: "Fiziksel veya online — ülke, şehir ve koordinatlar.",
        .estWizardPhotosTitle: "Fotoğraflar",
        .estWizardPhotosSub: "Logo ve en az üç galeri fotoğrafı.",
        .estWizardExistingBrands: "Markaların",
        .estWizardCreateBrand: "Organizasyon ve marka oluştur",
        .estWizardOrgNamePh: "Organizasyon adı",
        .estWizardBrandNamePh: "Marka adı",
        .estWizardEstablishmentNamePh: "Mekân adı",
        .estWizardCreateDraft: "Taslak oluştur",
        .estWizardSubmitReview: "İncelemeye gönder",
        .estWizardInstagramPh: "Instagram kullanıcı adı",
        .estWizardDescriptionCount: "%d / 200",
        .estWizardCategoriesLabel: "Kategoriler",
        .estWizardContactNamePh: "İletişim adı",
        .estWizardContactPhonePh: "İletişim telefonu",
        .estWizardContactIsSelf: "İletişim kişisi benim",
        .estWizardLocationType: "Konum türü",
        .estWizardPhysical: "Fiziksel",
        .estWizardOnline: "Online",
        .estWizardCountryPh: "Ülke",
        .estWizardCityPh: "Şehir",
        .estWizardAreaPh: "Bölge / mahalle",
        .estWizardAddress1Ph: "Adres satırı 1",
        .estWizardAddress2Ph: "Adres satırı 2 (isteğe bağlı)",
        ...
        .estWizardGalleryLabel: "Galeri",
        .estWizardAddGallery: "Galeri fotoğrafları ekle",
        .estWizardGalleryCount: "%d fotoğraf seçildi",
        .estWizardPhotosHint: "Bir logo ve en az 3 galeri fotoğrafı yükle.",
