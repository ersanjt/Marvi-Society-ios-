export const dictionaries = {
  en: {
    nav: { brands: "Brands", creators: "Creators", pricing: "Pricing", faq: "FAQ", demo: "Get demo", login: "Brand login" },
    hero: {
    ...
    forms: {
      contact: {
        ...
        safetyBody: "Report abusive behavior or urgent trust issues. Operators review every report.",
        safetyCta: "Submit report",
        safetyPlaceholder: "Describe what happened…",
        safetySent: "Report submitted. Thank you.",
        safetyFailed: "Could not send the report. Try again.",
        configError:
  ...
  tr: {
    nav: { brands: "Markalar", creators: "İçerik Üreticileri", pricing: "Fiyatlar", faq: "SSS", demo: "Demo Al", login: "Marka Girişi" },
    hero: {
    ...
    forms: {
      contact: {
        ...
        safetyBody: "Taciz edici davranışları veya acil güven sorunlarını bildirin. Operatörler her raporu inceler.",
        safetyCta: "Raporu gönder",
        safetyPlaceholder: "Ne olduğunu yazın…",
        safetySent: "Rapor gönderildi. Teşekkürler.",
        safetyFailed: "Rapor gönderilemedi. Tekrar deneyin.",
        configError:
